...
class UpdateCartCalculatorProvider with ChangeNotifier {
  ...
  void calculateAmountQty(CartData cartData) {
    ...
    num retailPrice = num.parse(cartData.productData!.retailTonAmount!);
    num minWholeSaleTon = cartData.productData!.wholeSaleTonMinQty!;
    num wholePrice = num.parse(cartData.productData!.wholeSaleTonAmount!);
    if (totalQty < 1000) {
