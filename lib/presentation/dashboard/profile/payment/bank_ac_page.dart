...
import 'widget/get_ac_details_widget.dart';
...
class _BankAcPageState
    extends State<BankAcPage> /* with AutomaticKeepAliveClientMixin*/ {
  ...
  void initState() {
    ...
    provider.setOrderPlaceLoaderFalse();
  }
    ...
    return SmartRefresher(
      ...
      child: Consumer<PaymentApiProvider>(
        builder: (BuildContext context, PaymentApiProvider paymentProvider,
          ...
          var bankData = paymentProvider.paymentMethodListModel?.bankData;
          return Padding(
              ...
              child: Column(
                ...
                children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                GetAcDetailsWidget(
                                                    title:
                                                        AppStrings.ifscCodeTxt,
                                                    value: bankData[index]
                                                        .ifscCode!),
                                                5.ph,
                                                GetAcDetailsWidget(
                                                    title:
                                                        AppStrings.micrCodeTxt,
                                                    value: bankData[index]
                                                        .micrCode!),
                                                5.ph,
                                                GetAcDetailsWidget(
                  ...
                  paymentProvider.orderPlaceLoading
                      ...
                      : paymentDataModel != null &&
                              paymentDataModel.bankData != null &&
                              paymentDataModel.totalOrderAmount != null &&
                          ...
                          ? CustomButton(
                              onPressed: () {
                                ...
                                if (selectedIndex == -1) {
                                  Utils.showToast("Please select bank account");
                                  return;
                                }
