                              ...
                              child: ButtonTheme(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  selectedItemBuilder: (BuildContext context) {
                                    return amtCalProvider.dropDownWeightList
                                        .map((value) {
                                      return Center(
                                        child: Text(
                                          value["status"],
                                  ...
                                  items: amtCalProvider.dropDownWeightList.map(
                                    (item) {
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: ButtonTheme(
                                alignedDropdown: true,
                                child: DropdownButton<String>(
                                  value: amtCalProvider.dropdownValueTwentyFive,
                                  isExpanded: true,
                                  isDense: true,
                                  style: AppTextStyles.bodyBlack14,
                                  onChanged: (onChangedValue) async {
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: ButtonTheme(
                                  alignedDropdown: true,
                                  child: DropdownButton<String>(
                                    value: amtCalProvider.dropdownValueRandom,
                                    isExpanded: true,
                                    isDense: true,
                                    style: AppTextStyles.bodyBlack14,
                                    onChanged: (onChangedValue) async {
                                    ...
                                    items:
                                        amtCalProvider.dropDownWeightList.map(
                                      (item) {
                                        return DropdownMenuItem(
                                          value: item["id"].toString(),
                                          child: Text(
